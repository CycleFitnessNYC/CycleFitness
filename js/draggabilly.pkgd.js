...
// left/top positioning
        Draggabilly.prototype.setLeftTop = function(x, y)
        {
            this.element.style.left = (typeof x !== 'undefined' ? x : this.position.x) + "px";
            this.element.style.top = (typeof y !== 'undefined' ? y : this.position.y) + "px";
        };

        Draggabilly.prototype.positionDrag =
            transformProperty ?
            function(x, y)
            {
        ...
        Draggabilly.prototype.translateTo = function(x, y)
        {
            this.element.style[ getStyleProperty('transform') ] = translate(x, y);
        }
